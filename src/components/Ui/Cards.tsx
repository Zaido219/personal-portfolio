...
export const HoverCards = ({children, className}:HoverCardProps) => {
    return(
        <div className={`bg-gray-100 dark:bg-zinc-900 w-fit overflow-hidden hover:bg-gray-300 dark:hover:bg-zinc-800 transition duration-200 ease-in-out hover:scale-103 rounded-md ${className}`}>
            {children}
        </div>
    )
}