...
const TechStackItem: React.FC<TechStackItemProps> = ({ name, icon, color }) => {
  return (
    <div className="group flex flex-col items-center justify-center gap-2 p-2 transition-transform duration-200 hover:-translate-y-1 cursor-pointer select-none">
