...
export const StackedProjectCard: React.FC<StackedProjectCardProps> = ({
  ...
  return (
    ...
    >
      <div>
        {/* Project Image */}
        <div className="w-full aspect-video rounded-xl overflow-hidden bg-white/60 dark:bg-neutral-950/40 backdrop-blur-md border border-black/5 dark:border-white/10 mb-5">
          {projectImage ? (
            <img
              src={projectImage}
            ...
            <div className="w-full h-full flex items-center justify-center text-neutral-600 dark:text-sunset-bright font-mono text-xs">
