...
export const ThemeToggle = () => {
  ...
  return (
    <button
      ...
      className="relative items-center inline-flex h-8 w-14 flex-shrink-0 cursor-pointer rounded-full border-1 border-transparent bg-slate-200 transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-offset-2 dark:bg-slate-700"
    >
      {/* 
        The Moving Thumb: 
